...
public class Iqsoft101_Response_NegotiateAPI extends Iqsoft_001_BaseTest {
    ...
    public void setTransportConnectTimeout(double transportConnectTimeout) {
    ...
    public void setLongPollDelay(double longPollDelay) {
